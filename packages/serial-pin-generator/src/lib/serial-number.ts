import { randomNumNot0 } from "./pin-generator";

export class SerialNumber{
  private totalNumOfDigits: number;
  private digitDivisions: any;
  private prefixCharacters: string;
  private numOfDigitsToGen: number;
  private lastNumber:  number;
  private somePath1: string;
  private somePath2: string;
  private somePath3: string;
  ...
  constructor(numOfDigits, prefixCharacters = ''){
    ...
    this.prefixCharacters = prefixCharacters.toUpperCase() || this.generatePrefix(null);
